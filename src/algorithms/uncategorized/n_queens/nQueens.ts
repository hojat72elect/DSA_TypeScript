...
function isSafe(queensPositions: (QueenPosition | null)[], rowIndex: number, columnIndex: number): boolean {
...
function nQueensRecursive(solutions: QueenPosition[][], previousQueensPositions: (QueenPosition | null)[], queensCount: number, rowIndex: number): boolean {

...
interface DfsCallbacks {
    enterVertex?: (args: { currentVertex: GraphVertex; previousVertex?: GraphVertex | null }) => void;
    leaveVertex?: (args: { currentVertex: GraphVertex; previousVertex?: GraphVertex | null }) => void;
 ...
 */
export function stronglyConnectedComponents(graph: Graph): GraphVertex[][] {

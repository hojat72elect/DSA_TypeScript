 ...
 */
export function detectDirectedCycle(graph: Graph): Record<string, GraphVertex> | null {
    ...
    const blackSet: Record<string, GraphVertex> = {};
    ...
    const callbacks = {
        enterVertex: ({currentVertex, previousVertex}: {
            ...
            if (graySet[currentVertex.getKey()]) {
                ...
                while (previousCycleVertex && previousCycleVertex.getKey() !== currentVertex.getKey()) {
                    cycle[currentCycleVertex.getKey()] = previousCycleVertex;
                    currentCycleVertex = previousCycleVertex;
                    previousCycleVertex = dfsParentMap[previousCycleVertex.getKey()] || null;
                }
        ...
        leaveVertex: ({currentVertex}: Omit<{
            currentVertex: GraphVertex;
            previousVertex: GraphVertex | null;
        }, 'previousVertex'>) => {

...
function isCycle(adjacencyMatrix: number[][], verticesIndices: Record<string | number, number>, cycle: GraphVertex[]): boolean {
...
function hamiltonianCycleRecursive(
    ...
    verticesIndices: Record<string | number, number>,
    cycles: GraphVertex[][],
    cycle: GraphVertex[],
) {
...
export function hamiltonianCycle(graph: Graph): GraphVertex[][] {

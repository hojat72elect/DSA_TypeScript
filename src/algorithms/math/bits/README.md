...
> See [isEven.ts](isEven.ts) for further details.
...
> See [isPositive.ts](isPositive.ts) for further details.
...
> See [multiply.ts](multiply.ts) for further details.
...
> See [fullAdder.ts](fullAdder.ts) for further details.

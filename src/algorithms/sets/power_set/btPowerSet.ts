/**
 * @param originalSet - Original set of elements we're forming power_set of.
 ...
 */
function btPowerSetRecursive(originalSet: any[], allSubsets: any[][] = [[]], currentSubSet: any[] = [], startAt: number = 0): any[][] {
...
/**
 * Find power_set of a set using BACKTRACKING approach.
 */
export function btPowerSet(originalSet: any[]): any[][] {

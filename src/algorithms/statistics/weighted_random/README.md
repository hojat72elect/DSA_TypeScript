...
- Check the [weightedRandom.ts](weightedRandom.ts) file for the implementation of the `weightedRandom()` function.
- Check the [weightedRandom.test.ts](./weightedRandom.test.ts) file for the tests-cases.

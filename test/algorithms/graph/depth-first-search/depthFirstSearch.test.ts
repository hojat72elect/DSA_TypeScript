...
import {depthFirstSearch} from '../../../../src/algorithms/graph/depth-first-search/depthFirstSearch.ts';
...
describe('depthFirstSearch', () => {
    it('should perform DFS operation on graph', () => {
        ...
        // @ts-ignore
        depthFirstSearch(graph, vertexA, {enterVertex: enterVertexCallback, leaveVertex: leaveVertexCallback,});

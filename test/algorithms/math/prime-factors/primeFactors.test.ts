import {hardyRamanujan, primeFactors} from "../../../../src/algorithms/math/prime_factors/primeFactors.ts";
 ...
 */
function approximationError(exactCount: any, approximateCount: any) {

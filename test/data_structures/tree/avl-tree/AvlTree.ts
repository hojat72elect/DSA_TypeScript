...
export class AvlTree<T> extends BinarySearchTree<T> {
    ...
    override remove(value: T): boolean {
        ...
        const isRemoved = super.remove(value);

        // Balance the tree starting from the root node.
        if (this.root) this.balance(this.root);
        return isRemoved;
    }

    public balance(node: BinarySearchTreeNode<T>) {
    ...
    public rotateLeftLeft(rootNode: BinarySearchTreeNode<T>) {
    ...
    public rotateLeftRight(rootNode: BinarySearchTreeNode<T>) {
    ...
    public rotateRightLeft(rootNode: BinarySearchTreeNode<T>) {
    ...
    public rotateRightRight(rootNode: BinarySearchTreeNode<T>) {
